...
/* 		animation: example;
		...
		if (lixoQnt == 6)
		{
			animal01.src = "../Recursos/Animais/Tartaruga-Feliz.gif";
		...
		if (lixoQnt == 3)
		{
			animal02.src = "../Recursos/Animais/Onca-feliz-final.gif";
		...
		if (lixoQnt == 0)
		{
			animal03.src = "../Recursos/Animais/Carangejo-feliz-final.gif";

...
/* 		animation: example;
		...
		if (lixoQnt == 6)
		{
			animal01.src = "../Recursos/Animais/Tamandua-Bandeira-Feliz.gif";
		...
		if (lixoQnt == 3)
		{
			animal02.src = "../Recursos/Animais/Cervo-feliz-final.gif";
		...
		if (lixoQnt == 0)
		{
			animal03.src = "../Recursos/Animais/Lobo-Guara-Feliz.gif";
